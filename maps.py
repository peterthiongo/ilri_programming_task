...
#   The following script will take gps nmea data from a provided text file or gps device
#   which acts as our data stream, for purposes of this example, I have used a .txt file.

#	Takes GPS position and altitude data and plots it on a scaled map image of your
#   The console interatcion allows you to configure what type of data strea you are using
